...
> Historical target state, not an implementation inventory. Current source and
> [AGENTS.md](../../AGENTS.md) take precedence. The Inkassa page was removed on
> 2026-09-05; historical transaction labels and backend records remain valid.
> Manager receipt currently uses CASH, HUMO (combined Card), and PAYME.
